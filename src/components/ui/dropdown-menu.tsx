  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "text-[var(--form-text)] hover:bg-[var(--form-hover-bg)] focus:bg-[var(--form-hover-bg)]",
        "data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8",
        "data-[variant=destructive]:text-destructive data-[variant=destructive]:hover:bg-destructive/10 dark:data-[variant=destructive]:hover:bg-destructive/20 data-[variant=destructive]:focus:bg-destructive/10 data-[variant=destructive]:focus:text-destructive data-[variant=destructive]:*:[svg]:!text-destructive",
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-2 py-1.5 text-sm font-medium text-[var(--form-text)] data-[inset]:pl-8",
        className,
      )}
      {...props}
    />
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("bg-[var(--form-text)] opacity-20 -mx-1 my-1 h-px", className)}
      {...props}
    />
  );
}
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "text-[var(--form-text)] hover:bg-[var(--form-hover-bg)] focus:bg-[var(--form-hover-bg)]",
        "data-[state=open]:bg-[var(--form-hover-bg)] data-[state=open]:text-[var(--form-text)]",
        "data-[inset]:pl-8",
        className,
      )}
      {...props}
